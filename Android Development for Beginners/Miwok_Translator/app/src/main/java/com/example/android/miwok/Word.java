...
public class Word
{
    private int mAudioID;                        // The audio resource ID number of the word
     ...
     * @param audioID is the audio resource ID number
     */
    public Word(String default_text, String miwok_text, int audioID) {
    ...
    public Word(int imageID, String default_text, String miwok_text, int audioID)
    {
        ...
        // Initialise the audio resource ID
        mAudioID = audioID;
    }

    // Get the audio resource ID number
